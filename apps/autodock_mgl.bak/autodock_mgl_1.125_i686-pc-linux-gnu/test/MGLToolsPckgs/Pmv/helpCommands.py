...
# 
#
# $Id: helpCommands.py,v 1.19 2008/03/27 20:02:29 sargis Exp $
#
...
class BugReportCommand(Command):
    ...
    def buildFormDescr(self, formName):
        ...
        idf = InputFormDescr(title='BugReport')
...
other information that would help us in fixing this bug:""",
        ...
        idf.append({'name':'emailentrylab',
                    ...
                    'wcfg':{'text':"Enter your email address(optional:to receive information about submitted bug)"
                            },
                    'gridcfg':{'sticky':'nw', 'columnspan':3}})
    ...
    def showpmvlog_cb(self):
        ...
        if var==1 :
                ...
                pmvlog_group.expand()   
                tx = self.vf.GUI.MESSAGE_BOX.tx
                message_list =   tx.get().split('\n')[:-2]
