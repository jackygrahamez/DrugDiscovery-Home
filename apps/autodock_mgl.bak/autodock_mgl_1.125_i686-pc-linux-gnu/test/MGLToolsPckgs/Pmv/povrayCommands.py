...
#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/povrayCommands.py,v 1.4 2004/05/28 02:16:18 sanner Exp $
#
# $Id: povrayCommands.py,v 1.4 2004/05/28 02:16:18 sanner Exp $
#
...
class Povray(MVCommand):
    ...
    PovrayIncDir = '/mgl/apps/src/povray/povray31/include'
