...
# $Header: /opt/cvs/python/packages/share1.5/Pmv/repairCommands.py,v 1.75 2008/06/19 20:59:59 dkeidel Exp $
#
# $Id: repairCommands.py,v 1.75 2008/06/19 20:59:59 dkeidel Exp $
#


from ViewerFramework.VFCommand import CommandGUI
from ViewerFramework.VF import AddAtomsEvent, DeleteAtomsEvent
...
\nclose is defined as interatomic distance< percentCutoff*(key_radius+check_radius) where the radii depend on atom element .
    ...
    def onAddCmdToViewer(self):
        if self.vf.hasGui and \
           not self.vf.commands.has_key('checkForCloseContacts'):
            self.vf.loadCommand('repairCommands', ['checkForCloseContacts'],
                                package='Pmv', topCommand=0)
        if self.vf.hasGui and \
           not self.vf.commands.has_key('saveSet'):
