...
#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/interactiveCommands.py,v 1.29 2007/01/26 01:37:41 vareille Exp $
#
# $Id: interactiveCommands.py,v 1.29 2007/01/26 01:37:41 vareille Exp $
#
...
class MVSetInteractiveCmd(MVCommand):
    ...
    def setupUndoBefore(self, cmd, modifier=None):
        cmdDict = self.vf.ICmdCaller.commands.value
        cmd = cmdDict[modifier]
        self.addUndoCall( (cmd, modifier), {}, self.name )


    def doit(self, cmd, modifier=None):
        icom = self.vf.ICmdCaller
        icom.setCommands(cmd, modifier)
        
        
    def __call__(self, cmd, modifier=None, **kw):
        ...
        for o in options:
            ...
            self.LevelOption._menu.entryconfigure(
                                 self.LevelOption._menu.index(o),
                                           ...
                                           activebackground = TkColor(col[o])) 
