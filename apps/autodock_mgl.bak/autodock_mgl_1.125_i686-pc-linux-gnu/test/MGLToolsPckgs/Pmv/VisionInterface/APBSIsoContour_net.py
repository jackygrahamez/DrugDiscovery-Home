...
#########################################################################
#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/VisionInterface/APBSIsoContour_net.py,v 1.39 2008/04/15 23:44:20 vareille Exp $
#
# $Id: APBSIsoContour_net.py,v 1.39 2008/04/15 23:44:20 vareille Exp $
#
...
try:
    ...
    code = """def doit(self, grid3D, isovalue=1.0, 
calculatesignatures=None, verbosity=None):
    ...
    data = grid3D.data
    if self.inputPortByName['grid3D'].hasNewData():
