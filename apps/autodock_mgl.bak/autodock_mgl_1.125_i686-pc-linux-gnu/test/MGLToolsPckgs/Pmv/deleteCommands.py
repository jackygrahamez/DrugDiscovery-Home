...
#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/deleteCommands.py,v 1.45 2008/06/02 23:34:33 rhuey Exp $
#
# $Id: deleteCommands.py,v 1.45 2008/06/02 23:34:33 rhuey Exp $
#
...
from ViewerFramework.VF import DeleteAtomsEvent
...
deleteAllMoleculesGuiDescr = {'widgetType':'Menu', 'menuBarName':'menuRoot',
                          'menuButtonName':'Edit',
                          'menuCascadeName':'Delete',
...
class DeleteAtomSet(MVCommand):
    ...
    def guiCallback(self, event=None):
        """called each time the 'Delete AtomSet' button is pressed"""
    ...
    def continue_cb(self, ats):
        self.vf.resetUndo(topCommand=0)
        self.doitWrapper(ats)
...
deleteAtomSetGuiDescr = {'widgetType':'Menu', 'menuBarName':'menuRoot',
                          'menuButtonName':'Edit',
                          'menuCascadeName':'Delete',
                          'menuEntryLabel':'Delete AtomSet'}

DeleteAtomSetGUI = CommandGUI()
DeleteAtomSetGUI.addMenuCommand('menuRoot', 'Edit', 'Delete AtomSet',
        cascadeName='Delete')
...
deleteHydrogensGuiDescr = {'widgetType':'Menu', 'menuBarName':'menuRoot',
                          'menuButtonName':'Edit',
                          'menuCascadeName':'Delete',
