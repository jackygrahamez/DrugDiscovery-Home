...
#
# $Header: /opt/cvs/python/packages/share1.5/Pmv/bondsCommands.py,v 1.45 2007/08/16 21:12:13 vareille Exp $
#
# $Id: bondsCommands.py,v 1.45 2007/08/16 21:12:13 vareille Exp $
#
#
import numpy.oldnumeric as Numeric
from opengltk.OpenGL import GL

from ViewerFramework.VF import EditAtomsEvent
...
buildBondsByDistanceDescr = {'widgeType':'Menu', 'menuBarName':'Edit',
   ...
   \nOptional Arguments:\n  
    ...
    def setupUndoBefore(self, atom1, atom2, bondOrder=1, origin='UserDefined'):
        ...
        self.addUndoCall((atom1.full_name(),atom2.full_name()),
                {'topCommand':0}, self.vf.removeBonds.name)
...
class RemoveBondsCommand(MVCommand):
   ...
   \nSynopsis:\n
    ...
    def setupUndoBefore(self, atom1, atom2):
        ...
        global var 
        if var ==0:
            self.addUndoCall( (atom1, atom2), {} ,self.vf.addBonds.name)
