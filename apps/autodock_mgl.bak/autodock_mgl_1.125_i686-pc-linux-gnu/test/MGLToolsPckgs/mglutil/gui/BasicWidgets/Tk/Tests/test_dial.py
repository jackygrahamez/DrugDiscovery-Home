...
# $Id: test_dial.py,v 1.7 2004/11/01 23:35:40 sophiec Exp $
...
#Invalid Inputs 
    ...
    def test_dial_invalid_value(self):
        ...
        """
        root =Tkinter.Tk()
        self.assertRaises(AssertionError,Dial,value = 'hai',master =root)
        root.destroy()
...
#invalid input for configure methods
    ...
    def test_invalid_setValue(self):
        ...
        root =Tkinter.Tk()
        dial =Dial(master = root)
        self.assertRaises(AssertionError,dial.setValue,'hai')
        dial.master.destroy()
