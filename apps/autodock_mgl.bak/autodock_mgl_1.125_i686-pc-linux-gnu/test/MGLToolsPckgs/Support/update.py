...
# $Header: /opt/cvs/Support/update.py,v 1.28 2008/02/29 23:22:10 sargis Exp $
# $Id: update.py,v 1.28 2008/02/29 23:22:10 sargis Exp $
...
class Update:
    ...
    def gui(self):
        ...
        text = "Update Manager"
        Tkinter.Label(self.master, text=text, bg='white', font=("Helvetica", 16)
    ...
    def checkUpdates(self):
        ...
        if self.tested_dir and date_latest:
