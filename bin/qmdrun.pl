...
$check = system("ps ax | grep qmdrun.pl | wc -l");
chomp($check);
...
$wu_name="nsteps_".$nsteps."_int_0_-_50000_bt_1ijy_lig_".$new_complex."_qmdrun_ts_".$time;
...
#copy the md.tpr used by mdrun workunit. Copy to the download directory using the dir_hier_path which sets the proper fanout directory
        $ARG1="cp ".$qmdrun."/md.tpr \`bin/dir_hier_path md_".$wu_name.".tpr\`";
        print $ARG1 . "\n";
        system($ARG1);

        $ARG1="cp ".$qmdrun."/md.mdp \`bin/dir_hier_path md_".$wu_name.".mdp\`";
        print $ARG1 . "\n";
        system($ARG1);

        $ARG1="cp ".$qmdrun."/md_job.xml \`bin/dir_hier_path md_job_".$wu_name.".txt\`";
        print $ARG1 . "\n";
        system($ARG1);

        $ARG1="cp ".$qmdrun."/Complex.top \`bin/dir_hier_path complex".$wu_name.".txt\`";
        print $ARG1 . "\n";
        system($ARG1);
