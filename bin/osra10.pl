...
$ARG=$PROJECT."bin/create_work -appname osra -wu_name osra_10_".$pid."_".$time." -wu_template /home/boincadm/projects/DrugDiscovery/templates/osra_wu -result_template ../templates/osra_result osra_".$pid."_".$time.".py";
print $ARG ."\n";
system($ARG);
sleep(10);
}
