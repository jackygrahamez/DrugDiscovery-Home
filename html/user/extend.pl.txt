...
print "ts: ".$ts."\n";
$name="_bt_".$bt."_lig_".$lig."_ts_".$ts;
...
$ARG1=$PROJECT."/bin/create_work -appname mdrun -wu_name nsteps_".$nsteps."_int_".$nstart."_-_".$nend.$name." -wu_template ".$PROJECT."/templates/mdrun_wu_extend -result_template templates/mdrun_result --rsc_fpops_est ".$rsc_fpops_est." --rsc_fpops_bound ".$rsc_fpops_bound." --delay_bound ".$delay_bound." nsteps_".$nsteps."_int_".$nstart."_-_".$nend.$name.".tpr job_".$nsteps."_int_".$nstart."_-_".$nend.$name.".txt next_".$nsteps."_int_".$nstart."_-_".$nend.$name.".cpt";
  print $ARG1 . "\n";
  system($ARG1);
...
$ARG="mv ".$tmp."/nsteps*rcs*23878*.7z ".$PROJECT."/sample_results/rcs_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*rcs*24103*.7z ".$PROJECT."/sample_results/rcs_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*rcs*24107*.7z ".$PROJECT."/sample_results/rcs_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*rcs*24171*.7z ".$PROJECT."/sample_results/rcs_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*rcs*23925*.7z ".$PROJECT."/sample_results/rcs_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*Autodock*23878*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*Autodock*34220*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*Autodock*25630*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*Autodock*37395*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*Autodock*36155*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*Autodock*36552*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*Autodock*36297*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*Autodock*32880*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);


$ARG="mv ".$tmp."/nsteps*bt_PMC*23878*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*bt_PMC*34220*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*bt_PMC*25630*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*bt_PMC*37395*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*bt_PMC*36155*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*bt_PMC*36552*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*bt_PMC*36297*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);

$ARG="mv ".$tmp."/nsteps*bt_PMC*32880*.7z ".$PROJECT."/sample_results/ad_traj";
print $ARG."\n";
system($ARG);
