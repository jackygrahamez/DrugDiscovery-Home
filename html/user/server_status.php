...
$df = `df | head -n 3 | tail -n 1 | awk '{ print substr( $0, length($0) - 4, 4 ) }'`;
$free = `free -m | head -n 2 | tail -n 1 | awk '{ print substr( $0, length($0) - 40, 10 ) }'`;
$total = `free -m | head -n 2 | tail -n 1 | awk '{ print substr( $0, length($0) - 60, 10 ) }'`;
...
if ($xml) {
    ...
    echo time_str(time()), "
        ...
        <p>Server status Disk Full: $df</p><p>Available Memory $free MB of $total MB</p>
