...
<link rel=\"icon\" href=\"/favicon.ico\" type=\"image/x-icon\">
	<div id=\"mainnav\">
        <h2>About ".PROJECT."</h2>
        DrugDiscovery@Home ".tra("is a research project that uses Internet-connected
        computers to model the behavior of leading compounds that could be developed into new medicines.
        You can participate by downloading and running a free program
        on your computer.")."
        <p>
        DrugDiscovery@Home is in an early alpha phase and does not have a formal relationship with 
	academia or the pharmaceutical industry. 
        <h2>Join ".PROJECT."</h2>
        <ul>
	<li><a href=\"server_status.php\"><b>".tra("Server Status")."</b></a>
